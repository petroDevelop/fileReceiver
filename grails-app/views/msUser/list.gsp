	...
	<head>
		...
		<script>
			function deleteFormatter(value, row) {
				var str='<a href="${request.contextPath}/msUser/delete/'+row.id+'"><button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-trash"></span> &nbsp;<g:message code="default.button.delete.label" default="Delete" /></button></a>';
				return str;
			}
			function editFormatter(value, row) {
				var str='<a href="${request.contextPath}/msUser/edit/'+row.id+'"><button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-edit"></span> &nbsp;<g:message code="default.button.edit.label" default="Edit" /></button></a>';
				return str;
			}
			function nameFormatter(value, row) {
				var str='<a href="${request.contextPath}/msUser/show/'+row.id+'">'+row.name+'</a>';
				return str;
			}
			...
			function deleteAll(){
				var selects=$('#msUserTable').bootstrapTable('getSelections');
				if(selects.length>0){
					var ids=new Array();
					...
					if(confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}')) {
						$.post("${request.contextPath}/msUser/deleteAll", obj,
								function (data, textStatus) {
									if (data.result) {
										...
										$('#msUserTable').bootstrapTable('refresh',[]);
									} else {
			...
			function importExcel(){
				$('#excelForm').form('submit', {
					url:'${request.contextPath}/msUser/importExel',
			...
			function newWindow(){
				document.location.href="${createLink(controller: 'msUser',action:'create')}";
			}
		</script>
	</head>
	<body>
	...
	<div >
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active" ><g:message code="msUser.label" default="MsUser" /></li>
			</ol>
		</div><!--/.row-->
		...
		<!--
			<div class="col-lg-12">
				<h1 class="page-header"><g:message code="msUser.label" default="MsUser" /></h1>
			</div>
			-->
				...
				<div class="panel panel-default">
					<g:form method="post">
						...
						<div class="panel-body">
							...
							<table id="msUserTable" data-toggle="table"  data-toolbar="#toolbar"
								   data-url="${request.contextPath}/msUser/json"   data-cache="false"
								...
								<tr>
									...
									<th data-field="userName"  data-sortable="true"   >${message(code: 'msUser.userName.label', default: 'User Name')}</th>
									
									<th data-field="userPwd"  data-sortable="true"   >${message(code: 'msUser.userPwd.label', default: 'User Pwd')}</th>
									
									<th data-field="rigName"  data-sortable="true"   >${message(code: 'msUser.rigName.label', default: 'Rig Name')}</th>
									


									<th data-field="msRole.text"  >${message(code: 'msUser.msRole.label', default: 'Ms Role')}</th>
