...
<html>
	...
	<body>
		<a href="#edit-msSmallFile" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-msSmallFile" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${msSmallFileInstance?.version}" />
				<fieldset class="form">
