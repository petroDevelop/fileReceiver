	...
	<head>
		...
		<script>
			function deleteFormatter(value, row) {
				var str='<a href="${request.contextPath}/msRole/delete/'+row.id+'"><button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-trash"></span> &nbsp;<g:message code="default.button.delete.label" default="Delete" /></button></a>';
				return str;
			}
			function editFormatter(value, row) {
				var str='<a href="${request.contextPath}/msRole/edit/'+row.id+'"><button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-edit"></span> &nbsp;<g:message code="default.button.edit.label" default="Edit" /></button></a>';
				return str;
			}
			function nameFormatter(value, row) {
				var str='<a href="${request.contextPath}/msRole/show/'+row.id+'">'+row.name+'</a>';
				return str;
			}
			...
			function deleteAll(){
				var selects=$('#msRoleTable').bootstrapTable('getSelections');
				if(selects.length>0){
					var ids=new Array();
					...
					if(confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}')) {
						$.post("${request.contextPath}/msRole/deleteAll", obj,
								function (data, textStatus) {
									if (data.result) {
										...
										$('#msRoleTable').bootstrapTable('refresh',[]);
									} else {
			...
			function importExcel(){
				$('#excelForm').form('submit', {
					url:'${request.contextPath}/msRole/importExel',
			...
			function newWindow(){
				document.location.href="${createLink(controller: 'msRole',action:'create')}";
			}
		</script>
	</head>
	<body>
	...
	<div >
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active" ><g:message code="msRole.label" default="MsRole" /></li>
			</ol>
		</div><!--/.row-->
		...
		<!--
			<div class="col-lg-12">
				<h1 class="page-header"><g:message code="msRole.label" default="MsRole" /></h1>
			</div>
			-->
				...
				<div class="panel panel-default">
					<g:form method="post">
						...
						<div class="panel-body">
							...
							<table id="msRoleTable" data-toggle="table"  data-toolbar="#toolbar"
								...
								<tr>
									...
									<th data-field="remark"  data-sortable="true"   >${message(code: 'msRole.remark.label', default: 'Remark')}</th>
